...
const journeys = (origin, destination, date = Date.now(), opt = {}) => {
	...
	const body = {
		...
		'results[5][5][data]': JSON.stringify([
			{ name: 'results[5][5][is_extended]', value: '1' },
			{ name: 'results[5][5][from]', value: origin },
			{ name: 'results[5][5][to]', value: destination },
			{ name: 'results[5][5][via]', value: options.via || '' },
			{ name: 'results[5][5][time_mode]', value: 'departure' },
			{ name: 'results[5][5][time]', value: time },
			{ name: 'results[5][5][date]', value: day },
			{ name: 'results[5][5][means_of_transport][]', value: 'STR' },
			{ name: 'results[5][5][means_of_transport][]', value: 'BUS' },
			{ name: 'results[5][5][means_of_transport][]', value: 'S/U' },
			{ name: 'results[5][5][means_of_transport][]', value: 'RB/RE' },
			{ name: 'results[5][5][mode]', value: 'connection' }
		])
	}

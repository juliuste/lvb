...
const journeys = (origin, destination, date = Date.now(), opt = {}) => {
	...
	const body = {
		'results[5][3][function]': 'ws_find_connections',
		'results[5][3][data]': JSON.stringify([
			{ name: 'results[5][3][is_extended]', value: '1' },
			{ name: 'results[5][3][from]', value: origin },
			{ name: 'results[5][3][to]', value: destination },
			{ name: 'results[5][3][via]', value: options.via || '' },
			{ name: 'results[5][3][time_mode]', value: 'departure' },
			{ name: 'results[5][3][time]', value: time },
			{ name: 'results[5][3][date]', value: day },
			{ name: 'results[5][3][means_of_transport][]', value: 'STR' },
			{ name: 'results[5][3][means_of_transport][]', value: 'BUS' },
			{ name: 'results[5][3][means_of_transport][]', value: 'S/U' },
			{ name: 'results[5][3][means_of_transport][]', value: 'RB/RE' },
			{ name: 'results[5][3][mode]', value: 'connection' }
		])
	}

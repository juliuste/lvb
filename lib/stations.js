...
const getStationID = (s) => {
	const body = {
		'results[5][3][function]': 'ws_info_stop',
		'results[5][3][data]': JSON.stringify([
			{ name: 'results[5][3][stop]', value: s },
			{ name: 'results[5][3][date]', value: moment.tz('Europe/Berlin').add(1, 'days').format('DD.MM.YYYY') },
			{ name: 'results[5][3][time]', value: '' },
